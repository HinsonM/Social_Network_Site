...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a href="#" class="navbar-brand"><img src="image/logo.jpg" width="40" height="40" alt=""></a>
<!--        -->
        ...
        <#if user??>
            ...
            <button class="btn btn-info" data-toggle="modal" data-target="#exampleModal" style="margin-left: 25px">发布微博
            </button>
        <#else>
