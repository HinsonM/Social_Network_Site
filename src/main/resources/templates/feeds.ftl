                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p>
                            ...
                            <a href="/question/${feed.getDataJson('questionId')}">
                                ${feed.getDataJson('questionTitle')}
                            </a>
                        </p>
                        <div class="row-fluid">
                            <div class="col-sm-12">
                                <p>
                                    ${feed.getDataJson('questionContent')}
                                </p>
                            </div>
                        </div>
                    </div>
...
<div class="container" style="margin-top: 50px">
    ...
    <div class="row">
        <div class="col-sm-8 col-lg-8 col-md-8 col-xl-8">
            <div class="row">
                <div class="col-sm-3" align="center">
                    <img width="100px" height="100px" alt="image" src="${feed.getDataJson('userHead')}"/>
                        <#if user??>
                            <#if feed.userId == user.id>
                        <button class="btn btn-light" data-toggle="modal" data-target="#messageModal"
                                style="margin-top: 20px" data-id="${feed.userId}" disabled>发送私信
